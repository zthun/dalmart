...
describe("Storage", () => {
  ...
  const shouldReturnTheFallbackIfTheKeyIsNotSet = async (
  ...
  const shouldInsertTheDataIfItDoesNotExist = async (
    createTestTarget: () => IZDatabaseMemory,
  ) => {
    // Arrange.
    const key = createGuid();
  ...
  const shouldReturnTheDataThatWasJustUpdated = async (
    createTestTarget: () => IZDatabaseMemory,
  ) => {
    // Arrange.
    const key = createGuid();
  ...
  const shouldUpdateTheDataInPlace = async (
    createTestTarget: () => IZDatabaseMemory,
  ) => {
    // Arrange.
    const expected = 55;
  ...
  const shouldDeleteAllKeys = async (
    createTestTarget: () => IZDatabaseMemory,
  ) => {
    // Arrange.
  ...
  describe("Local", () => {
    ...
    describe("Read", () => {
      it("should insert the key if the key does not exist and the fallback is set", async () => {
        await shouldInsertTheKeyIfTheKeyDoesNotExistAndTheFallbackIsSet(
          createTestTarget,
        );
      });

      it("should return null if the key does not exist and no fallback is set", async () => {
        await shouldReturnNullIfTheKeyDoesNotExistAndTheFallbackIsNotSet(
          createTestTarget,
        );
      });
